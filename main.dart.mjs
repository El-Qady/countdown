...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1380: (t, s) => t.set(s),
      _1381: l => new DataView(new ArrayBuffer(l)),
      ...
      _1440: x0 => x0.cancel(),
      _1441: x0 => x0.read(),
      _1448: (x0,x1) => x0.createElement(x1),
      ...
      _2326: (x0,x1) => { x0.crossOrigin = x1 },
      _2329: (x0,x1) => { x0.preload = x1 },
